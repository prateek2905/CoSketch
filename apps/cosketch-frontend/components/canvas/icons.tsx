...
export function FreedrawIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M3 17c2-4 4-6 6-6s3 4 5 4 3-6 6-6" />
      <path d="M3 20h18" />
    </svg>
  );
}
...
export function EraserIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M3 17 13 7a2 2 0 0 1 2.8 0l3.2 3.2a2 2 0 0 1 0 2.8L9 23H5l-2-2z" />
      <path d="M16 8l3 3" />
    </svg>
  );
}
